...
bdf_file = "CRM_V12wingbox_COARSE_1.bdf"
...
response = llm.generate_answer("1.查询模型中的单元编号为5417的单元属性 2.运行nastran去执行这个BDF仿真任务 3.把网格转化为gmsh格式且命名为converted_mesh.msh打开Gmsh浏览")
